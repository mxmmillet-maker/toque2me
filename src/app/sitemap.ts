...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/marquage`, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/marquage/broderie`, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${BASE_URL}/marquage/serigraphie`, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${BASE_URL}/marquage/dtf`, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${BASE_URL}/marquage/impression-numerique`, changeFrequency: 'monthly', priority: 0.7 },
